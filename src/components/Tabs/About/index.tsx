		...
		>
			<div className='flex flex-col justify-between gap-20 p-2 text-base md:text-lg bg-[url("/assets/circlesBG.png")] bg-center bg-cover bg-no-repeat'>
				...
				<div className='flex flex-col gap-6'>
					...
					<p>
						Possuo experiência profissional com <strong>Java</strong> & <strong>Selenium</strong>, porém sempre mantive ativo nos estudos realizando projetos pessoais com outras ferramentas e linguagens.
					</p>
